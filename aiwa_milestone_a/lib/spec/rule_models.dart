class Strictness { final String value; const Strictness._(this.value);
...
class RuleSet {
  ...
  final Map<String,dynamic> counts;   // minIntervalMs, windowMs, minValleyKneeAngle{relaxed,strict}
  ...
  RuleSet({required this.template, required this.version, required this.counts,
           required this.phases, required this.metrics, required this.scoreWeights,
